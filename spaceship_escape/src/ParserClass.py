...
class Parser:
    def __init__(self):
        ...
        self.features = ['door', 'lamp', 'water cooler', 'clamps', 'ship', 'poster', 'footlocker', 'window', 'screens', 'meals', 'seat', 'button', 'paper', 'charts', 'pillars', 'servitor', 'diagram', 'console', 'DRD', 'emptiness', 'lights', 'supplies', 'barrels', 'loader', 'instruments', 'expanse']
